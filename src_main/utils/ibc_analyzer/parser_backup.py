...
class ASTNode:
    """AST节点类"""
    def __init__(self, uid: str = "", parent_uid: str = "", children_uids: List[str] = None, 
                 node_type: NodeType = None, line_number: int = 0, identifier: str = "",
                 content: str = "", external_desc: str = "", intent_comment: str = "",
                 params: Dict[str, str] = None, symbol_refs: Dict[str, str] = None):
        self.uid = uid
