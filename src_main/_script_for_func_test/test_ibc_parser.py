...
var config"""
    ...
    try:
        ...
        for uid in root_node.children_uids:
            ...
            var_names.append(var_node.identifier)
        
        assert "userCount" in var_names, "缺少userCount变量"
        assert "cacheData" in var_names, "缺少cacheData变量"
        assert "config" in var_names, "缺少config变量"
