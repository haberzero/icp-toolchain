...
2. **内容规范**：
   ...
   - 严禁添加非代码核心逻辑的文件，包括但不限于：
      - README文件(readme/README/ReadMe等任何形式)
      - 文档文件(CHANGELOG/CONTRIBUTING/LICENSE/AUTHORS等)
      - 说明性文件(INSTALL/USAGE/TODO/NOTES等)
      - 配置文件(CONFIG等)
      - 仅允许添加实现具体功能逻辑的代码文件
...
- 步骤 5: 文件类型验证，确保所有添加的文件均为代码核心逻辑文件，排除任何README、文档、说明等非功能性文件
- 预期结果: 新JSON包含精准定位的功能文件节点（仅包含代码实现文件）
